...
// GgoodLog holds the configuration settings for the ggood logger.
type GgoodLog struct {
	Level   string `description:"Log level set to ggood logs." json:"level,omitempty" toml:"level,omitempty" yaml:"level,omitempty" export:"true"`
	Format  string `description:"Ggood log format: json | common" json:"format,omitempty" toml:"format,omitempty" yaml:"format,omitempty" export:"true"`
	...
	FilePath   string `description:"Ggood log file path. Stdout is used when omitted or empty." json:"filePath,omitempty" toml:"filePath,omitempty" yaml:"filePath,omitempty"`
